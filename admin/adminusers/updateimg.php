...
<div class="margin add_administrator" id="page_style">
    ...
    <div class="title_name">修改头像</div>
    <form action="action.php?a=updateimg" method="post" id="form-admin-add" enctype="multipart/form-data">
    <ul>
	...
	<input type="hidden" class="input-text col-xs-12" value="<?php echo $stu['id'];?>" placeholder="" id="user-tel" name="id" datatype="m" >
	 ...
	 <li class="clearfix">
		...
		<input type="hidden" name="img1" value="<?php echo $stu['img'];?>">
		<input type="hidden" name="image1" value="<?php echo $stu['image']; ?>">
